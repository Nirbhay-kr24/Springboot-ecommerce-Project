...
import com.SpringCart.ecommerce.service.cart.ICartItemService;
import com.SpringCart.ecommerce.service.cart.ICartService;
import com.SpringCart.ecommerce.service.user.IUserService; // Ensure this import exists
...
public class CartItemController {
    ...
    private final IUserService userService; // ✅ Injected to fetch User
    ...
    public ResponseEntity<ApiResponse> addItemToCart(@RequestParam(required = false) Long cartId,
        ...
        try {
            if (cartId == null) {
                // ✅ Fetch the user and pass them to initializeNewCart
